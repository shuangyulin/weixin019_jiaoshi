          ...
          <el-form-item class="input" v-if="ruleForm.qiandaoshijian" label="签到时间" prop="qiandaoshijian">
              <el-input v-model="ruleForm.qiandaoshijian" 
                placeholder="签到时间" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.ketangtupian" label="课堂图片" prop="ketangtupian">
          <file-upload
          tip="点击上传课堂图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.ketangtupian?ruleForm.ketangtupian:''"
          @change="ketangtupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.ketangtupian" label="课堂图片" prop="ketangtupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.ketangtupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                      </el-row>
                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="课堂内容" prop="ketangneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.ketangneirong" label="课堂内容" prop="ketangneirong">
                    <span>{{ruleForm.ketangneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="课后反馈" prop="kehoufankui">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="课后反馈"
                  v-model="ruleForm.kehoufankui" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kehoufankui" label="课后反馈" prop="kehoufankui">
                    <span>{{ruleForm.kehoufankui}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="学生掌握程度" prop="xueshengzhangwochengdu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="学生掌握程度"
                  v-model="ruleForm.xueshengzhangwochengdu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xueshengzhangwochengdu" label="学生掌握程度" prop="xueshengzhangwochengdu">
                    <span>{{ruleForm.xueshengzhangwochengdu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                    ...
                                                                                    ketangtupianUploadChange(fileUrls) {
                this.ruleForm.ketangtupian = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                            	addEditStyleChange() {
	  this.$nextTick(()=>{
